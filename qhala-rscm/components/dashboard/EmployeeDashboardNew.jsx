...
const EmployeeDashboardNew = ({ user }) => {
  ...
  const stats = {
    capacity: Math.round(data.capacity || 0),
    allocatedHours: data.allocatedHours || 0,
    standardHours: data.standardHours || 40,
      ...
      <div className="bg-white rounded-lg shadow-sm">
        <div className="px-6 py-4 border-b border-gray-100">
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Your capacity, projects, and skills
          </p>
        </div>
        ...
        <div className="grid grid-cols-4 divide-x divide-gray-100">
          <div className="px-6 py-5 hover:bg-rscm-dutch-white/30 transition-colors cursor-pointer group">
            ...
            <div className="text-xs text-gray-500">My capacity</div>
          </div>
          ...
          <div className="px-6 py-5 hover:bg-rscm-dutch-white/30 transition-colors cursor-pointer group">
            <div className="flex items-baseline gap-2 mb-1">
              ...
              <span className="text-xs text-gray-500">/ {stats.standardHours}h</span>
            </div>
            <div className="text-xs text-gray-500">Allocated hours</div>
          </div>
          ...
          <div className="px-6 py-5 hover:bg-rscm-dutch-white/30 transition-colors cursor-pointer group">
            <div className="flex items-baseline gap-2 mb-1">
              ...
              <Briefcase size={14} className="text-rscm-violet opacity-0 group-hover:opacity-100 transition-opacity" />
            </div>
          ...
          <div className="divide-y divide-gray-50">
            {projects.length > 0 ? (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3 flex-1">
                      <div className="p-1.5 bg-rscm-violet/10 rounded mt-0.5">
                        <Briefcase size={14} className="text-rscm-violet" />
                      </div>
                      <div className="flex-1 min-w-0">
              ...
              <div className="px-6 py-12 text-center">
                <Briefcase size={32} className="mx-auto mb-2 text-gray-400 opacity-50" />
